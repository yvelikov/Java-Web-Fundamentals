...
public class RequestHandlerLoader {
    ...
    private Map<String, RequestHandler> loadedRequestHandlers;
    ...
    private void loadLibrary(JarFile library, String canonicalPath) {
        ...
        try {
            ...
            while (fileEntries.hasMoreElements()) {
                ...
                Class handlerClazz = urlClassLoader.loadClass(className);
                if (RequestHandler.class.isAssignableFrom(handlerClazz)) {
                    RequestHandler handlerObject = (RequestHandler) handlerClazz.getConstructor(String.class).newInstance(WebConstants.WEB_SERVER_ROOT_FOLDER_PATH);

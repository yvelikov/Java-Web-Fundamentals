...
public class Server {
    ...
    public Server(int port, String serverRootPath, Iterable<RequestHandler> requestHandlers) {
        this.port = port;
        this.timeouts = 0;
        ...
        while (true) {
            try (Socket clientSocket = this.server.accept()) {
                ...
                ConnectionHandler connectionHandler
                        = new ConnectionHandler(clientSocket, this.serverRootPath ,this.requestHandlers);
